...
BIG_SPREAD_RESIDUAL_ROWS = [
    ...
    {
        "photo_group": "2009-P Return to Monticello nickel", "source_images": "IMG_1278 Large.jpeg, IMG_1279 Large.jpeg",
        "category": "Circulating Nickel", "denomination": "5 cents",
        "country": "USA", "year": 2009, "mint_mark": "P",
        "design_variety": "Jefferson nickel, \"Return to Monticello\" design (script Liberty signature)",
        "coin_spec_key": "Jefferson Nickel",
        "obverse_text": "IN GOD WE TRUST / Liberty (script) / 2009 P", "reverse_text": "not photographed in this crop",
        "condition_notes": "Clear, well-struck, date and mintmark both legible", "qty": 1,
        "est_value_low_usd": 0.05, "est_value_high_usd": 0.05,
        "value_basis": "Face value - common date/mintmark",
        "confidence": "high",
        "notes": "Confirmed by user: 2009 Return to Monticello nickel, minted in Philadelphia. Corrects an earlier catalog entry that had misread this pair as \"1974\" - the script \"Liberty\" signature alone rules out 1974 (arched LIBERTY text era). IMG_1279 is an edge-on shot (plain edge, consistent with a nickel) likely documenting this coin or its pair below.",
        "crop_file": None, "box_id": None, "wheat_reverse": False,
    },
    {
        "photo_group": "Jefferson nickel - Westward Journey reverse", "source_images": "IMG_1278 Large.jpeg",
        "category": "Circulating Nickel", "denomination": "5 cents",
        "country": "USA", "year": "2004-2005 (Westward Journey series)", "mint_mark": "not legible in photo",
        "design_variety": "Jefferson nickel, Westward Journey commemorative reverse (exact design - Peace Medal/Keelboat/Bison/Ocean in View - not confidently identified due to wear and rotation)",
        "coin_spec_key": "Jefferson Nickel",
        "obverse_text": "not shown in this crop", "reverse_text": "IN GOD WE TRUST / mountainous scene with a standing figure - worn, exact Westward Journey variant unclear",
        "condition_notes": "Moderate wear obscures the fine reverse detail needed for a certain sub-type ID", "qty": 1,
        "est_value_low_usd": 0.05, "est_value_high_usd": 0.05,
        "value_basis": "Face value expected - all 4 Westward Journey reverse varieties are common in circulation",
        "confidence": "low",
        "notes": "\"IN GOD WE TRUST\" on the reverse rules out a Buffalo/Indian Head nickel (which never carries that motto) - this is a Jefferson nickel with one of the 2004-2005 Westward Journey commemorative reverses. Re-photograph straight-on for a firm sub-type ID.",
        "crop_file": None, "box_id": None, "wheat_reverse": False,
    },
    {
        "photo_group": "Jefferson nickel - undated #1", "source_images": "IMG_1277 Large.jpeg",
        "category": "Circulating Nickel", "denomination": "5 cents",
        "country": "USA", "year": None, "mint_mark": "not legible in photo",
        "design_variety": "Jefferson nickel, standard Monticello reverse",
        "coin_spec_key": "Jefferson Nickel",
        "obverse_text": "not shown in this crop", "reverse_text": "MONTICELLO / FIVE CENTS / UNITED STATES OF AMERICA / E PLURIBUS UNUM",
        "condition_notes": "Reverse-only crop; date is on the obverse and isn't visible here", "qty": 1,
        "est_value_low_usd": 0.05, "est_value_high_usd": 0.05,
        "value_basis": "Face value expected for a common-date Jefferson nickel",
        "confidence": "low",
        "notes": "Photographed reverse-up alongside the coin below; re-photograph the obverse for a date.",
        "crop_file": None, "box_id": None, "wheat_reverse": False,
    },
    {
        "photo_group": "Jefferson nickel - undated #2", "source_images": "IMG_1277 Large.jpeg",
        "category": "Circulating Nickel", "denomination": "5 cents",
        "country": "USA", "year": None, "mint_mark": "not legible in photo",
        "design_variety": "Jefferson nickel, standard Monticello reverse",
        "coin_spec_key": "Jefferson Nickel",
        ...
        "value_basis": "Face value expected for a common-date Jefferson nickel",
        "confidence": "low",
        "notes": "Photographed reverse-up alongside the coin above; re-photograph the obverse for a date.",
        "crop_file": None, "box_id": None, "wheat_reverse": False,
    },
    {
        "photo_group": "Jefferson nickel (pre-ID CL-20260707-BOX01-PS001-0001)", "source_images": "IMG_1280 Medium.jpeg, IMG_1281 Medium.jpeg, IMG_1282 Medium.jpeg",
        "category": "Circulating Nickel", "denomination": "5 cents",
        "country": "USA", "year": None, "mint_mark": "not legible in photo",
        "design_variety": "Jefferson nickel, \"Return to Monticello\" design (script Liberty signature)",
        "coin_spec_key": "Jefferson Nickel",
        "obverse_text": "IN GOD WE TRUST / Liberty (script) / date partially obscured, reads approximately \"200_\"",
        "reverse_text": "UNITED STATES OF AMERICA / E PLURIBUS UNUM / MONTICELLO (partially legible)",
        "condition_notes": "Obverse, reverse, and edge (plain, no reeding - consistent with a nickel) all individually photographed on top of a printed pre-ID label",
        "qty": 1,
        "est_value_low_usd": 0.05, "est_value_high_usd": 0.05,
        "value_basis": "Face value expected for a common post-2005 date",
        "confidence": "low",
        "notes": "First coin catalogued under the new pre-ID label system: CL-20260707-BOX01-PS001-0001 (date-BOX-photoset-item). All 3 photos confirmed to be the same physical coin (obverse/reverse/edge), so the shared ID is correct usage, not a duplicate-labeling mistake. Re-photograph the obverse straight-on to pin down the exact year.",
        "crop_file": None, "box_id": None, "wheat_reverse": False,
    },
]
